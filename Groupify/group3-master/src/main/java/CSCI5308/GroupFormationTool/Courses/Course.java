...
public class Course {
	...
	public void setDefaults() {
		...
		id = -1;
		title = "";
		userRoleDecider = courseAbstractFactory.returnCourseUserRelationship();
	}
	...
	public void loadCourseByID(ICoursePersistence courseDB) {
		courseDB.loadCourseByID(this.id,this);
	}
	
	public List<Course> loadAllCourses(ICoursePersistence courseDB){
